...
<div id="wrapper">
   ...
   <center><font face=verdana color=red>${status}</center></font>
	...
	<th><font size="" color="black">Raise Issue</th>
	</tr>
	...
	<td><a href="RaiseIssueRequest?t1=${bfb.id}&t2=${bfb.droneno}&t3=${bfb.dronemodel}"><font size="" color="black">Click Here</font></a></td>
    </tr>
    </c:forEach>
    </table>
