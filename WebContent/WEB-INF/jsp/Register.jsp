...
<div id="wrapper">
	...
	<div id="splash">
		<img class="pic" src="${pageContext.request.contextPath}/js/images/investor.jpg" width="870" height="230" alt="" />
			...
			<center>
<form:form method="post" action="StoreRegister" modelAttribute="Register">
<br/>
   <h3><b>Manager Registration Screen</b></h3>
   ...
   <center><font face=verdana color=red>${status}</center></font>
		  ...
		  <td colspan="4"><font size="" color="black"><form:checkbox path="skills" value="Planning" label="Planning"/>
		  <form:checkbox path="skills" value="Monitoring" label="Monitoring"/>
		  <form:checkbox path="skills" value="Leading" label="Leading"/>
		  <form:checkbox path="skills" value="Organizing" label="Organizing"/>
		  </td>
