...
<div id="wrapper">
	...
	<div id="splash">
		<img class="pic" src="${pageContext.request.contextPath}/js/images/investor.jpg" width="870" height="230" alt="" />
			...
			<center>
<form:form method="post" action="EditDroneDetails" modelAttribute="EditDrone">
<br/>
   <h2><b>Edit Drone Details Screen</b></h2>
